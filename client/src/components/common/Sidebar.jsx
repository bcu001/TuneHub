...
const Sidebar = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center p-2 text-inherit">
      <div
        className={`relative h-full shrink-0 flex flex-col justify-between rounded-md p-4 duration-300 ease-in-out overflow-hidden shadow-ui ${
      ...
      >
        ...
        <Link
          ...
          className={`flex items-center gap-2 rounded-md  duration-300 ease-in-out cursor-pointer ${
            isSidebar
              ? "justify-start bg-gray-100 p-2 shadow-ui"
              : "justify-center"
          } `}
        >
          {/* Profile Avatar */}
